...
class getLunWenTeacherUpdate extends Command
{
    ...
    public function handle()
    {
        ...
        if (count($res['teacherFileList'])>1||count($res['teacherMessageList'])>1) {
            $this->sendDD('老师批改了你的论文记得查阅，这是老师第'.count($res['teacherMessageList']).'次批阅，老师说了以下内容：'.$res['teacherMessageList'][1]['message']);
        }
